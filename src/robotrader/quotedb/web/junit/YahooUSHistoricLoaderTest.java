...
/**
 * Simple test for loading quotes from Yahoo! US
 * @author klinst
 */
public class YahooUSHistoricLoaderTest extends TestCase
{
	String instr = "MSFT";
	String startdate = "20001231";
	String enddate = "20030115";
	YahooUSHistoricLoader _loader;

	public YahooUSHistoricLoaderTest(String name)
	{
		super(name);
	}
	...
	{
		super.setUp();
		 _loader = new YahooUSHistoricLoader();
	}
