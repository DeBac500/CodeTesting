...
/**
 * Quotes loader for Yahoo! FR (www.yahoo.fr) quotes in csv format.
 * since 01.2003, month and days are zero based
 * 
 * @author xcapt
 * @author klinst
 */
public class YahooFRHistoricLoader extends BaseYahooLoader 
{
	/** trace object */
	private static Logger trace =
		Logger.getLogger(YahooFRHistoricLoader.class);
	 ...
	 * constructor
	 */
	public YahooFRHistoricLoader()
	{
		super();
		_splitMonth = true; // Yahoo FR does not seem to allow 
	 ...
	 * @return The robotrader date in yyyyMMdd
	 */
		...
		String enddate) 
	{
		...
		StringBuffer buf = new StringBuffer();
		buf.append("http://ichart.yahoo.com/table.csv?a=");
