 ...
 * DefaultApplication
 */
public abstract class AbstractOutlookApplication extends AbstractGUIApplication {
	
	public AbstractOutlookApplication(String title, String configfile)
	{
		super();
		OutlookMainView.getInstance(title);
